...
DISCORD_GUILD_ID="Discord guild ID, optional, for backwards compatibility with single server setups" \
DISCORD_GUILD_IDS="a space-separated list of Discord guild IDs" \
